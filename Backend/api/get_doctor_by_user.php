...
try {
    ...
    // Authorization check: User can only access their own doctor data, or Admin can access any.
...
try {
    ...
    $query = "SELECT Id, Name, Specialty, UserId, CancellationPolicyHours FROM Doctors WHERE UserId = ?";
    ...
    if ($result->num_rows > 0) {
        ...
        send_json_response(200, $doctor);
    } else {
        send_json_response(404, ['message' => 'Doctor not found for the specified User ID.']);
    }
